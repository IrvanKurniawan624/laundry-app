                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <span
                                                class="round-8 text-bg-secondary rounded-circle me-2 d-inline-block"></span>
                                    ...
                                    <div class="card w-100">
                                        <div class="card-body">
                                            <div class="p-2 bg-primary-subtle rounded-2 d-inline-block mb-3">
                                                <img src="../assets/images/svgs/icon-cart.svg" alt="chart-img"
                                    ...
                                    <div class="card w-100">
                                        <div class="card-body">
                                            <div class="p-2 bg-info-subtle rounded-2 d-inline-block mb-3">
                                                <img src="../assets/images/svgs/icon-bar.svg" alt="chart-img"
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                        ...
                                        <div class="col-4">
                                            <div class="d-flex justify-content-end">
                                                <div class="p-2 bg-primary-subtle rounded-2 d-inline-block">
                                                    <img src="../assets/images/svgs/icon-master-card-2.svg"
                                                        alt="chart-img" class="img-fluid" width="24" height="24">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-paypal2.svg"
                                                        alt="chart-img" class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-wallet.svg" alt="chart-img"
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-credit-card.svg"
                                                        alt="chart-img" class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-7 pb-1">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-pie2.svg" alt="chart-img"
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <table class="table align-middle text-nowrap mb-0">
                                            ...
                                            <tbody class="border-top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge fw-semibold py-1 w-85 bg-info-subtle text-info">Very
                                                            high</span>
                                                    </td>
                                                    <td>
                                                        <p class="fs-3 text-dark mb-0">$3.5k</p>
            ...
            <div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight"
                ...
                <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
                        ...
                        <li class="pb-7">
                            <div class="d-flex align-items-center">
                                <img src="../assets/images/products/product-3.jpg" width="95" height="75"
                                    class="rounded-1 me-9 flex-shrink-0" alt="chart-img" />
                                <div>
                    ...
                    <div class="align-bottom">
                        ...
                        <a href="../dark/eco-checkout.html" class="btn btn-outline-primary w-100">Go to shopping
                            cart</a>
                    </div>
                </div>
            </div>
